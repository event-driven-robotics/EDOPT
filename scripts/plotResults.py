...
# ax1.plot(ekom_pitch['t'], ekom_pitch['x'], color=color_x, label='x')
# ax1.plot(ekom_pitch['t'], ekom_pitch['y'], color=color_y, label='y')
# ax1.plot(ekom_pitch['t'], ekom_pitch['z'], color=color_z, label='z')
# ax1.plot(gt_pitch['t'], gt_pitch['x'], color=color_x, ls='--')
# ax1.plot(gt_pitch['t'], gt_pitch['y'], color=color_y, ls='--')
# ax1.plot(gt_pitch['t'], gt_pitch['z'], color=color_z, ls='--')
# # ax1.plot(rgbde_pitch['t'], rgbde_pitch['x'], 'r-.')
# # ax1.plot(rgbde_pitch['t'], rgbde_pitch['y'], 'g-.')
# # ax1.plot(rgbde_pitch['t'], rgbde_pitch['z'], 'b-.')
# ax2.plot(ekom_pitch['t'], ekom_pitch['qx'], color=color_qx, label='qx')
# ax2.plot(ekom_pitch['t'], ekom_pitch['qy'], color=color_qy, label='qy')
# ax2.plot(ekom_pitch['t'], ekom_pitch['qz'], color=color_qz, label='qz')
# ax2.plot(ekom_pitch['t'], ekom_pitch['qw'], color=color_qw, label='qw')
# ax2.plot(gt_pitch['t'], gt_pitch['qx'], color=color_qx, ls='--')
# ax2.plot(gt_pitch['t'], gt_pitch['qy'], color=color_qy, ls='--')
# ax2.plot(gt_pitch['t'], gt_pitch['qz'], color=color_qz, ls='--')
# ax2.plot(gt_pitch['t'], gt_pitch['qw'], color=color_qw, ls='--')
...
rgbde_yaw_resampled_qx = resampling_by_interpolate(gt_yaw['t'], rgbde_yaw['t'], rgbde_yaw['qx'])
rgbde_yaw_resampled_qy = resampling_by_interpolate(gt_yaw['t'], rgbde_yaw['t'], rgbde_yaw['qy'])
rgbde_yaw_resampled_qz = resampling_by_interpolate(gt_yaw['t'], rgbde_yaw['t'], rgbde_yaw['qz'])
rgbde_yaw_resampled_qw = resampling_by_interpolate(gt_yaw['t'], rgbde_yaw['t'], rgbde_yaw['qw'])
...
fig_summary.set_size_inches(18.5, 15.5)
...
axs[2,2].plot(rgbde_yaw['t'], rgbde_yaw['x'], color=color_x, ls='-.')
axs[2,2].plot(rgbde_yaw['t'], rgbde_yaw['y'], color=color_y, ls='-.')
axs[2,2].plot(rgbde_yaw['t'], rgbde_yaw['z'], color=color_z, ls='-.')
axs[1,0].plot(ekom_trans_x['t'], ekom_trans_x_alpha, color=color_x, label='qx')
axs[1,0].plot(ekom_trans_x['t'], ekom_trans_x_beta, color=color_y, label='qy')
axs[1,0].plot(ekom_trans_x['t'], ekom_trans_x_gamma, color=color_z, label='qz')
axs[1,0].plot(gt_trans_x['t'], gt_trans_x_alpha, color=color_x, ls = '--')
axs[1,0].plot(gt_trans_x['t'], gt_trans_x_beta, color=color_y, ls = '--')
axs[1,0].plot(gt_trans_x['t'], gt_trans_x_gamma, color=color_z, ls = '--')
axs[1,0].plot(rgbde_time_trans_x, rgbde_trans_x_alpha, color=color_x, ls = '-.')
axs[1,0].plot(rgbde_time_trans_x, rgbde_trans_x_beta, color=color_y, ls = '-.')
axs[1,0].plot(rgbde_time_trans_x, rgbde_trans_x_gamma, color=color_z, ls = '-.')
axs[1,1].plot(ekom_trans_y['t'], ekom_trans_y_alpha, color=color_x, label='qx')
axs[1,1].plot(ekom_trans_y['t'], ekom_trans_y_beta, color=color_y, label='qy')
axs[1,1].plot(ekom_trans_y['t'], ekom_trans_y_gamma, color=color_z, label='qz')
axs[1,1].plot(gt_trans_y['t'], gt_trans_y_alpha, color=color_x, ls = '--')
axs[1,1].plot(gt_trans_y['t'], gt_trans_y_beta, color=color_y, ls = '--')
axs[1,1].plot(gt_trans_y['t'], gt_trans_y_gamma, color=color_z, ls = '--')
axs[1,1].plot(rgbde_time_trans_y, rgbde_trans_y_alpha, color=color_x, ls = '-.')
axs[1,1].plot(rgbde_time_trans_y, rgbde_trans_y_beta, color=color_y, ls = '-.')
axs[1,1].plot(rgbde_time_trans_y, rgbde_trans_y_gamma, color=color_z, ls = '-.')
axs[1,2].plot(ekom_trans_z['t'], ekom_trans_z_alpha, color=color_x, label='qx')
axs[1,2].plot(ekom_trans_z['t'], ekom_trans_z_beta, color=color_y, label='qy')
axs[1,2].plot(ekom_trans_z['t'], ekom_trans_z_gamma, color=color_z, label='qz')
axs[1,2].plot(gt_trans_z['t'], gt_trans_z_alpha, color=color_x, ls = '--')
axs[1,2].plot(gt_trans_z['t'], gt_trans_z_beta, color=color_y, ls = '--')
axs[1,2].plot(gt_trans_z['t'], gt_trans_z_gamma, color=color_z, ls = '--')
axs[1,2].plot(rgbde_time_trans_z, rgbde_trans_z_alpha, color=color_x, ls = '-.')
axs[1,2].plot(rgbde_time_trans_z, rgbde_trans_z_beta, color=color_y, ls = '-.')
axs[1,2].plot(rgbde_time_trans_z, rgbde_trans_z_gamma, color=color_z, ls = '-.')
axs[3,0].plot(ekom_roll['t'], ekom_roll_alpha, color=color_x, label='qx')
axs[3,0].plot(ekom_roll['t'], ekom_roll_beta, color=color_y, label='qy')
axs[3,0].plot(ekom_roll['t'], ekom_roll_gamma, color=color_z, label='qz')
axs[3,0].plot(gt_roll['t'], gt_roll_alpha, color=color_x, ls = '--')
axs[3,0].plot(gt_roll['t'], gt_roll_beta, color=color_y, ls = '--')
axs[3,0].plot(gt_roll['t'], gt_roll_gamma, color=color_z, ls = '--')
axs[3,0].plot(rgbde_time_roll, rgbde_roll_alpha, color=color_x, ls = '-.')
axs[3,0].plot(rgbde_time_roll, rgbde_roll_beta, color=color_y, ls = '-.')
axs[3,0].plot(rgbde_time_roll, rgbde_roll_gamma, color=color_z, ls = '-.')
axs[3,1].plot(ekom_pitch['t'], ekom_pitch_alpha, color=color_x, label='x or roll')
axs[3,1].plot(ekom_pitch['t'], ekom_pitch_beta, color=color_y, label='y or pitch')
axs[3,1].plot(ekom_pitch['t'], ekom_pitch_gamma, color=color_z, label='z or yaw')
axs[3,1].plot(gt_pitch['t'], gt_pitch_alpha, color=color_x, ls = '--')
axs[3,1].plot(gt_pitch['t'], gt_pitch_beta, color=color_y, ls = '--')
axs[3,1].plot(gt_pitch['t'], gt_pitch_gamma, color=color_z, ls = '--')
axs[3,1].plot(rgbde_time_pitch, rgbde_pitch_alpha, color=color_x, ls = '-.')
axs[3,1].plot(rgbde_time_pitch, rgbde_pitch_beta, color=color_y, ls = '-.')
axs[3,1].plot(rgbde_time_pitch, rgbde_pitch_gamma, color=color_z, ls = '-.')
axs[3,2].plot(ekom_yaw['t'], ekom_yaw_alpha, color=color_x, label='x or roll')
axs[3,2].plot(ekom_yaw['t'], ekom_yaw_beta, color=color_y, label='y or pitch')
axs[3,2].plot(ekom_yaw['t'], ekom_yaw_gamma, color=color_z, label='z or yaw')
axs[3,2].plot(gt_yaw['t'], gt_yaw_alpha, color=color_x, ls = '--')
axs[3,2].plot(gt_yaw['t'], gt_yaw_beta, color=color_y, ls = '--')
axs[3,2].plot(gt_yaw['t'], gt_yaw_gamma, color=color_z, ls = '--')
axs[3,2].plot(rgbde_time_yaw, rgbde_yaw_alpha, color=color_x, ls = '-.')
axs[3,2].plot(rgbde_time_yaw, rgbde_yaw_beta, color=color_y, ls = '-.')
axs[3,2].plot(rgbde_time_yaw, rgbde_yaw_gamma, color=color_z, ls = '-.')
for i in range(0, 4):
    for j in range(0, 3):
        axs[i,j].set_xlim([-2, 48])
...
axs[3,0].set_ylim(-120,  200)
axs[3,1].set_ylim(-120,  200)
axs[3,2].set_ylim(-120,  200)
axs[0,0].set_xticks([])
axs[1,0].set_xticks([])
axs[2,0].set_xticks([])
axs[0,1].set_xticks([])
...
fig_summary.subplots_adjust(wspace=0.06, hspace=0.06)
plt.show()
