...
quart_vec_pos=[ekom_error_trans_x, rgbde_error_trans_x, ekom_error_trans_y, rgbde_error_trans_y, ekom_error_trans_z, rgbde_error_trans_z, ekom_error_roll, rgbde_error_roll, ekom_error_pitch, rgbde_error_pitch, ekom_error_yaw, rgbde_error_yaw]
quart_vec_ang=[ekom_q_angle_trans_x, rgbde_q_angle_trans_x, ekom_q_angle_trans_y, rgbde_q_angle_trans_y, ekom_q_angle_trans_z, rgbde_q_angle_trans_z, ekom_q_angle_roll, rgbde_q_angle_roll, ekom_q_angle_pitch, rgbde_q_angle_pitch, ekom_q_angle_yaw, rgbde_q_angle_yaw]
