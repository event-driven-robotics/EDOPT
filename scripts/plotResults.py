...
ekom_trans_x = np.genfromtxt(os.path.join(filePath_dataset, 'results/dragon/new/x.csv'), delimiter=",", names=["t", "x", "y", "z", "qx", "qy", "qz", "qw"])
ekom_trans_y = np.genfromtxt(os.path.join(filePath_dataset, 'results/dragon/new/y.csv'), delimiter=",", names=["t", "x", "y", "z", "qx", "qy", "qz", "qw"])
ekom_trans_z = np.genfromtxt(os.path.join(filePath_dataset, 'results/dragon/new/z.csv'), delimiter=",", names=["t", "x", "y", "z", "qx", "qy", "qz", "qw"])
ekom_roll = np.genfromtxt(os.path.join(filePath_dataset, 'results/dragon/new/roll.csv'), delimiter=",", names=["t", "x", "y", "z", "qx", "qy", "qz", "qw"])
ekom_pitch = np.genfromtxt(os.path.join(filePath_dataset, 'results/dragon/new/pitch.csv'), delimiter=",", names=["t", "x", "y", "z", "qx", "qy", "qz", "qw"])
ekom_yaw = np.genfromtxt(os.path.join(filePath_dataset, 'results/dragon/new/yaw.csv'), delimiter=",", names=["t", "x", "y", "z", "qx", "qy", "qz", "qw"])
...
axs[0,0].plot(ekom_trans_x['t'], ekom_trans_x['x'], color=color_x, lw=4, label='x')
axs[0,0].plot(ekom_trans_x['t'], ekom_trans_x['y'], color=color_y, lw=4, label='y')
axs[0,0].plot(ekom_trans_x['t'], ekom_trans_x['z'], color=color_z, lw=4, label='z')
...
axs[0,1].plot(ekom_trans_y['t'], ekom_trans_y['x'], color=color_x, lw=4, label='x')
axs[0,1].plot(ekom_trans_y['t'], ekom_trans_y['y'], color=color_y, lw=4, label='y')
axs[0,1].plot(ekom_trans_y['t'], ekom_trans_y['z'], color=color_z, lw=4, label='z')
...
axs[0,2].plot(ekom_trans_z['t'], ekom_trans_z['x'], color=color_x, lw=4, label='x')
axs[0,2].plot(ekom_trans_z['t'], ekom_trans_z['y'], color=color_y, lw=4, label='y')
axs[0,2].plot(ekom_trans_z['t'], ekom_trans_z['z'], color=color_z, lw=4, label='z')
...
axs[2,2].plot(ekom_roll['t'], ekom_roll['x'], color=color_x, lw=4, label='x')
axs[2,2].plot(ekom_roll['t'], ekom_roll['y'], color=color_y, lw=4, label='y')
axs[2,2].plot(ekom_roll['t'], ekom_roll['z'], color=color_z, lw=4, label='z')
...
axs[2,0].plot(ekom_pitch['t'], ekom_pitch['x'], color=color_x, lw=4, label='x')
axs[2,0].plot(ekom_pitch['t'], ekom_pitch['y'], color=color_y, lw=4, label='y')
axs[2,0].plot(ekom_pitch['t'], ekom_pitch['z'], color=color_z, lw=4, label='z')
...
axs[2,1].plot(ekom_yaw['t'], ekom_yaw['x'], color=color_x, lw=4, label='x')
axs[2,1].plot(ekom_yaw['t'], ekom_yaw['y'], color=color_y, lw=4, label='y')
axs[2,1].plot(ekom_yaw['t'], ekom_yaw['z'], color=color_z, lw=4, label='z')
...
axs[1,0].plot(ekom_trans_x['t'], ekom_trans_x_alpha_cleaned, color=color_x, lw=4, label='qx')
axs[1,0].plot(ekom_trans_x['t'], ekom_trans_x_beta_cleaned, color=color_y, lw=4, label='qy')
axs[1,0].plot(ekom_trans_x['t'], ekom_trans_x_gamma_cleaned, color=color_z, lw=4, label='qz')
...
axs[1,1].plot(ekom_trans_y['t'], ekom_trans_y_alpha_cleaned, color=color_x, lw=4, label='qx')
axs[1,1].plot(ekom_trans_y['t'], ekom_trans_y_beta_cleaned, color=color_y, lw=4, label='qy')
axs[1,1].plot(ekom_trans_y['t'], ekom_trans_y_gamma_cleaned, color=color_z, lw=4, label='qz')
...
axs[1,2].plot(ekom_trans_z['t'], ekom_trans_z_alpha_cleaned, color=color_x, lw=4, label='qx')
axs[1,2].plot(ekom_trans_z['t'], ekom_trans_z_beta_cleaned, color=color_y, lw=4, label='qy')
axs[1,2].plot(ekom_trans_z['t'], ekom_trans_z_gamma_cleaned, color=color_z, lw=4, label='qz')
...
axs[3,2].plot(ekom_roll['t'], ekom_roll_alpha_cleaned, color=color_x, lw=4, label='qx')
axs[3,2].plot(ekom_roll['t'], ekom_roll_beta_cleaned, color=color_y, lw=4, label='qy')
axs[3,2].plot(ekom_roll['t'], ekom_roll_gamma_cleaned, color=color_z, lw=4, label='qz')
...
axs[3,0].plot(ekom_pitch['t'], ekom_pitch_alpha_cleaned, color=color_x, lw=4)
axs[3,0].plot(ekom_pitch['t'], ekom_pitch_beta_cleaned, color=color_y, lw=4)
axs[3,0].plot(ekom_pitch['t'], ekom_pitch_gamma_cleaned, color=color_z, lw=4)
...
axs[3,1].plot(ekom_yaw['t'], ekom_yaw_alpha_cleaned, color=color_x, label="x / "+r'$\alpha$'+" (pitch)", lw=4)
axs[3,1].plot(ekom_yaw['t'], ekom_yaw_beta_cleaned, color=color_y, label="y / "+r'$\beta$'+" (yaw)", lw=4)
axs[3,1].plot(ekom_yaw['t'], ekom_yaw_gamma_cleaned, color=color_z, label="z / "+r'$\gamma$'+" (roll)", lw=4)
...
quart_vec_ang=[ekom_q_angle_yaw*rad_to_deg, rgbde_q_angle_yaw*rad_to_deg, ekom_q_angle_pitch*rad_to_deg, rgbde_q_angle_pitch*rad_to_deg, ekom_q_angle_roll*rad_to_deg, rgbde_q_angle_roll*rad_to_deg, ekom_q_angle_trans_z*rad_to_deg, rgbde_q_angle_trans_z*rad_to_deg, ekom_q_angle_trans_y*rad_to_deg, rgbde_q_angle_trans_y*rad_to_deg, ekom_q_angle_trans_x*rad_to_deg, rgbde_q_angle_trans_x*rad_to_deg]
