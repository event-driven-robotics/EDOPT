...
dragon_eros_trans_x = np.genfromtxt(os.path.join(filePath_dataset, 'eros-new/x.csv'), delimiter=",", names=["t", "x", "y", "z", "qx", "qy", "qz", "qw"])
dragon_eros_trans_y = np.genfromtxt(os.path.join(filePath_dataset, 'eros-new/y.csv'), delimiter=",", names=["t", "x", "y", "z", "qx", "qy", "qz", "qw"])
dragon_eros_trans_z = np.genfromtxt(os.path.join(filePath_dataset, 'eros-new/z.csv'), delimiter=",", names=["t", "x", "y", "z", "qx", "qy", "qz", "qw"])
dragon_eros_roll = np.genfromtxt(os.path.join(filePath_dataset, 'eros-new/roll.csv'), delimiter=",", names=["t", "x", "y", "z", "qx", "qy", "qz", "qw"])
dragon_eros_pitch = np.genfromtxt(os.path.join(filePath_dataset, 'eros-new/pitch.csv'), delimiter=",", names=["t", "x", "y", "z", "qx", "qy", "qz", "qw"])
dragon_eros_yaw = np.genfromtxt(os.path.join(filePath_dataset, 'eros-new/yaw.csv'), delimiter=",", names=["t", "x", "y", "z", "qx", "qy", "qz", "qw"])
...
gelatin_eros_trans_x = np.genfromtxt(os.path.join(filePath_dataset, 'eros-new/x.csv'), delimiter=",", names=["t", "x", "y", "z", "qx", "qy", "qz", "qw"])
gelatin_eros_trans_y = np.genfromtxt(os.path.join(filePath_dataset, 'eros-new/y.csv'), delimiter=",", names=["t", "x", "y", "z", "qx", "qy", "qz", "qw"])
gelatin_eros_trans_z = np.genfromtxt(os.path.join(filePath_dataset, 'eros-new/z.csv'), delimiter=",", names=["t", "x", "y", "z", "qx", "qy", "qz", "qw"])
gelatin_eros_roll = np.genfromtxt(os.path.join(filePath_dataset, 'eros-new/roll.csv'), delimiter=",", names=["t", "x", "y", "z", "qx", "qy", "qz", "qw"])
gelatin_eros_pitch = np.genfromtxt(os.path.join(filePath_dataset, 'eros-new/pitch.csv'), delimiter=",", names=["t", "x", "y", "z", "qx", "qy", "qz", "qw"])
gelatin_eros_yaw = np.genfromtxt(os.path.join(filePath_dataset, 'eros-new/yaw.csv'), delimiter=",", names=["t", "x", "y", "z", "qx", "qy", "qz", "qw"])
...
mustard_eros_trans_x = np.genfromtxt(os.path.join(filePath_dataset, 'eros-new/x.csv'), delimiter=",", names=["t", "x", "y", "z", "qx", "qy", "qz", "qw"])
mustard_eros_trans_y = np.genfromtxt(os.path.join(filePath_dataset, 'eros-new/y.csv'), delimiter=",", names=["t", "x", "y", "z", "qx", "qy", "qz", "qw"])
mustard_eros_trans_z = np.genfromtxt(os.path.join(filePath_dataset, 'eros-new/z.csv'), delimiter=",", names=["t", "x", "y", "z", "qx", "qy", "qz", "qw"])
mustard_eros_roll = np.genfromtxt(os.path.join(filePath_dataset, 'eros-new/roll.csv'), delimiter=",", names=["t", "x", "y", "z", "qx", "qy", "qz", "qw"])
mustard_eros_pitch = np.genfromtxt(os.path.join(filePath_dataset, 'eros-new/pitch.csv'), delimiter=",", names=["t", "x", "y", "z", "qx", "qy", "qz", "qw"])
mustard_eros_yaw = np.genfromtxt(os.path.join(filePath_dataset, 'eros-new/yaw.csv'), delimiter=",", names=["t", "x", "y", "z", "qx", "qy", "qz", "qw"])
...
tomato_eros_trans_x = np.genfromtxt(os.path.join(filePath_dataset, 'eros-new/x.csv'), delimiter=",", names=["t", "x", "y", "z", "qx", "qy", "qz", "qw"])
tomato_eros_trans_y = np.genfromtxt(os.path.join(filePath_dataset, 'eros-new/y.csv'), delimiter=",", names=["t", "x", "y", "z", "qx", "qy", "qz", "qw"])
tomato_eros_trans_z = np.genfromtxt(os.path.join(filePath_dataset, 'eros-new/z.csv'), delimiter=",", names=["t", "x", "y", "z", "qx", "qy", "qz", "qw"])
tomato_eros_roll = np.genfromtxt(os.path.join(filePath_dataset, 'eros-new/roll.csv'), delimiter=",", names=["t", "x", "y", "z", "qx", "qy", "qz", "qw"])
tomato_eros_pitch = np.genfromtxt(os.path.join(filePath_dataset, 'eros-new/pitch.csv'), delimiter=",", names=["t", "x", "y", "z", "qx", "qy", "qz", "qw"])
tomato_eros_yaw = np.genfromtxt(os.path.join(filePath_dataset, 'eros-new/yaw.csv'), delimiter=",", names=["t", "x", "y", "z", "qx", "qy", "qz", "qw"])
...
potted_eros_trans_x = np.genfromtxt(os.path.join(filePath_dataset, 'eros-new/x.csv'), delimiter=",", names=["t", "x", "y", "z", "qx", "qy", "qz", "qw"])
potted_eros_trans_y = np.genfromtxt(os.path.join(filePath_dataset, 'eros-new/y.csv'), delimiter=",", names=["t", "x", "y", "z", "qx", "qy", "qz", "qw"])
potted_eros_trans_z = np.genfromtxt(os.path.join(filePath_dataset, 'eros-new/z.csv'), delimiter=",", names=["t", "x", "y", "z", "qx", "qy", "qz", "qw"])
potted_eros_roll = np.genfromtxt(os.path.join(filePath_dataset, 'eros-new/roll.csv'), delimiter=",", names=["t", "x", "y", "z", "qx", "qy", "qz", "qw"])
potted_eros_pitch = np.genfromtxt(os.path.join(filePath_dataset, 'eros-new/pitch.csv'), delimiter=",", names=["t", "x", "y", "z", "qx", "qy", "qz", "qw"])
potted_eros_yaw = np.genfromtxt(os.path.join(filePath_dataset, 'eros-new/yaw.csv'), delimiter=",", names=["t", "x", "y", "z", "qx", "qy", "qz", "qw"])
