...
public:
    ...
    bool configure(yarp::os::ResourceFinder& rf) override
    {
        ...
        block_size = rf.check("block_size", Value(14)).asInt32();//14
        ...
        int blur = proc_size / 5; // 5 for x,y,z,roll and 20 for pitch,yaw
